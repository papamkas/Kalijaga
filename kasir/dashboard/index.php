  ...
  <div class="container-scroller">
    ...
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        ...
        <a class="sidebar-brand brand-logo-mini text-kalijaga" href="#">K</a>
        ...
        <li class="nav-item menu-items">
          ...
          <div class="collapse" id="ui-basic">
            <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="./pesanan/pesanan_makanan.php">Pesanan Makanan</a></li>
              <li class="nav-item"> <a class="nav-link" href="./pesanan/pesanan_minuman.php">Pesanan Minuman</a></li>
            </ul>
          </div>
        </li>
        <li class="nav-item menu-items">
          <a class="nav-link" href="./pesanan/pesanan_history.php">
            <span class="menu-icon">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            <div class="btn-group ">
                              <button type="button" class="btn btn-outline-danger btn-fw" data-toggle="dropdown"> Menunggu Pembayaran
                              </button>
                              <div class="dropdown-menu">
                                <a class="dropdown-item"> <button type="button" class="btn btn-outline-warning btn-fw">Sedang Dikerjakan</button>
                                </a>
                                <a class="dropdown-item"> <button type="button" class="btn btn-outline-success btn-fw">Selesai</button>
                                </a>
                              </div>
                            </div>
                          </td>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="btn-group ">
                              <button type="button" class="btn btn-outline-warning btn-fw" data-toggle="dropdown"> Sedang Dikerjakan
                              </button>
                              <div class="dropdown-menu">
        ...
        <!-- Modal -->
        <div class="modal fade" id="staticBackdropRincian"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropRincian" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered ">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropRincian">Rincian Pesanan</h5>
        ...
        <!-- Modal -->
        <div class="modal fade" id="staticBackdropPembayaran"  data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropPembayaran" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              <div class="modal-header">
