    ...
    <div class="row w-100 justify-content-center">
      <div class="col-md-7 col-lg-4">
        <div class="p-4 bg-body-tertiary rounded-4 border shadow text-center">
          ...
          <!-- QR Code Section -->
          <img src="../assets/img/qr-code.png" class="img-fluid rounded mx-auto mb-3" alt="QR Code"
            data-bs-toggle="modal" data-bs-target="#imageModal" onclick="showImage(this)">
          <h2 class="text-coklat">Boleh Di Scan Yaaa</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="row w-100 justify-content-center">
    <div class="col-md-7 col-lg-5">
      <div class="p-4 bg-body-tertiary rounded-4 border shadow">
        ...
        <div class="d-flex justify-content-between mt-2">
          <span>Status:</span> <span class="text-danger">Menunggu Pembayaran</span>
        </div>
        <hr>
        <p class="text-success mb-2">Upload Bukti Pembayaran ya kak</p>
        <!-- Upload Section -->
        <form id="form-upload">
          <div class="input-group">
            <input type="file" class="form-control" id="inputGroupFile02" required>
            <button class="btn btn-success" type="submit" id="btn-submit">Kirim</button>
          </div>
        </form>
      </div>
    </div>
